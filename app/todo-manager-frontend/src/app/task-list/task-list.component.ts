...
export class TaskListComponent implements OnInit {
  ...
  priorityPrecedence: { [key in Priority]: number } = {
    [Priority.Low]: 1,
    [Priority.Medium]: 2,
    [Priority.High]: 3
  };

  sortByPriority(unsortedList: Task[]): Task[] {
    return unsortedList.sort((a, b) => {
      return this.priorityPrecedence[b.priority] - this.priorityPrecedence[a.priority];
    });
  }
